...
public class OrderController {
    ...
    ApiResponse<Void> updateStatusOrder(@PathVariable Integer orderId, @RequestBody OrderRequest orderRequest){
        orderService.updateOrderStatus(orderId, orderRequest);
    return ApiResponse.<Void>builder().code(200).message("Cập nhập đơn hàng thành công").build();
    }
