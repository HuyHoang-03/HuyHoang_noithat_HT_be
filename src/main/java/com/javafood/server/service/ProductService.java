...
public class ProductService {
    ...
    public ProductResponse updateProduct(Integer productId, ProductRequest productRequest) throws IOException {
        ...
        try {
            ...
            if (productRequest.getDimensions() != null) {
                productEntity.setDimensions(productRequest.getDimensions());
            }
    ...
    public Page<ProductResponse> getProductByCategoryAdmin(int pageNo, int pageSize, String sortBy, String sortDir, Integer categoryId) {
        try {
            ...
            // Lấy dữ liệu từ repository
            Page<ProductEntity> productsPagination = productRepository.getProductsByCategoryAdmin(pageable, categoryId);
